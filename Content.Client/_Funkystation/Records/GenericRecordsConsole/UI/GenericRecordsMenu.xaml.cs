...
public sealed partial class GenericRecordsMenu : FancyWindow
{
    ...
    /// <summary>
    /// literally only use this to avoid repeating the build sequence
    /// </summary>
    private Control CreateCollapsible(string header, Control body)
    {
        var element = new CollapsibleBody();
        element.AddChild(body);
        return new Collapsible(header, element);
    }
